...
def vote(serial_one, serial_two, vid):
    ...
    response = session.post('https://akb48-sousenkyo.jp/akb/vote', data = {'serial1': serial_one, 'serial2': serial_two, 's_key': skey_value, 'hash': hash_value, 'id': vid})
